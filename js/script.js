...
const worksData = [
  ...
  },
  {
    ...
    client: { ko: "주식회사ETPI", en: "ETPI Inc.", ja: "株式会社ETPI" },
  ...
  },
  {
    ...
    contribution: { ko: "50% (팀 2인)", en: "50% (Team of 2)", ja: "50%(2人チーム)" },
    responsibilities: {
      ko: ["패키지 디자인", "랜딩 페이지 디자인", "리테일 디스플레이 디자인", "캠페인 디자인", "UI/UX"],
      en: ["Packaging Design", "Landing Page Design", "Retail Display Design", "Campaign Design", "UI/UX"],
      ja: ["パッケージデザイン", "ランディングページデザイン", "リテールディスプレイデザイン", "キャンペーンデザイン", "UI/UX"]
    },
    disclaimer: {
  ...
  },
  {
    ...
    responsibilities: {
      ko: ["브랜드 전략", "로고 디자인", "비주얼 아이덴티티", "UI/UX"],
      en: ["Brand Strategy", "Logo Design", "Visual Identity", "UI/UX"],
      ja: ["ブランド戦略", "ロゴデザイン", "ビジュアルアイデンティティ", "UI/UX"]
    }
  },
  {
    id: "16",
